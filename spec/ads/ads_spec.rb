describe "poster ads", :type => :feature do
  ...
  it "appears on a blog page" do
    visit 'http://www.usatoday.com/story/life/music/2014/06/22/jimmy-c-newman-opry/11237203/'
    expect(page).to have_css(".poster-ad-asset-module")
  end

  it "appears on a story with priority video page" do
    visit 'http://www.usatoday.com/story/news/nation/2014/06/23/christian-radio-host-charged-sex-probe/11251795/'
    wait_for_pageload
    expect(page).to have_css(".poster-ad-asset-module")
  ...
  it "appears on a video page" do
    visit 'http://www.usatoday.com/videos/news/politics/2014/07/16/12728105/'
    expect(page).to have_css(".poster-ad-asset-module")
    expect(".ui-video-wrapper").to be_above ".poster-ad-asset-module"
  end
